...
public class MyController {
    ...
    public ResponseEntity<String> saveToken(@RequestBody TokenRequest tokenRequest) {
        ...
        try {
            ...
            Files.write(filePath, token.getBytes(), StandardOpenOption.WRITE);
            System.out.println("Токен успешно сохранен в файл: " + filePath.toAbsolutePath());
            } catch (IOException e) {
                System.err.println("Ошибка при записи токена в файл: " + e.getMessage());
        }
